...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/09/03 15:00:59 by mida              #+#    #+#             */
/*   Updated: 2021/09/03 15:05:18 by mida             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	thread_init(t_e *e)
{
	...
	while (i < e->arg.nb_of_philo)
	{
		...
		if (pthread_create(&e->philo[i].thread_ident, NULL, \
					ft_thread, &e->philo[i]) != 0)
